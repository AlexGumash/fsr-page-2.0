        ...
        <div id="team-container" class="team-container">
          <div class="choose-team">
            <div class="choose-team-notification">
              <span>
                To register as marshal please send the request. Wait for confirmation by an organizer. After confirmation, you will be registered as marshal.
              </span>
            </div>
            <!-- тут нужен другой хэндлер -->
            <form class="" action="../handlers/group-marshal.php" method="post">
            <!-- тут нужен другой хэндлер -->
              ...
              <input type="submit" name="marshal-request" value="Send request">
            </form>
